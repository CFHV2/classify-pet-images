...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # 1. Create a dictionary of dog names
    dognames_dic = dict()

    # Read file dognames.txt
    ...
    # 2. Loop through results_dic to add info
    for key in results_dic:
        ...
        # 3. The Label is a dog?
        if pet_label in dognames_dic:
            is_pet_dog = 1
        else:
            is_pet_dog = 0

        # 4. Classifier Label is a dog?
        is_classifier_dog = 0

        # The classifier can return multiple words separated by commas.
        classifier_words = classifier_label.split(",")

        for word in classifier_words:
            if word.strip() in dognames_dic:
                is_classifier_dog = 1
                break

        # 5. Include the Results (index 3 & 4)
