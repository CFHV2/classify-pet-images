...
def get_pet_labels(image_dir):
    ...
    # Empty dictionary where we will store results
    results_dic = dict()
    ...
    for filename in filename_list:
        ...
        # We built the label using only alphabetic words
        pet_label = ""
        ...
        # Include the name in the dictionary only if the key does not exist
        if filename not in results_dic:
            results_dic[filename] = [pet_label]
        else:
            print("** Warning: duplicate file exists in results_dic =", filename)
